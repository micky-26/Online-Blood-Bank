...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 02, 2023 at 12:17 PM
...
(1, 'Techno Plaza, Circular Road,Patna, India-800015', '+9198736255, 0612747388', 'info@bbcamp.com');
...
CREATE TABLE IF NOT EXISTS `contact_query` (
  ...
  `query_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(1, 'Anuj', 'anuj@gmail.com', '9923471025', 'I need O+ Blood.', '2023-01-27 06:11:23', 1),
(2, 'Lee', 'lee@gmail.com', '34352554', 'bxbxfbf', '2023-01-27 14:26:19', 1),
(3, 'vm', '65864864', 'micky@26', 'ghcdyhxx', '2023-01-31 13:54:59', NULL),
(4, 'sfc', '242353152', 'micky@26', 'we wefhwbfhw wefwjh', '2023-02-01 06:01:27', NULL);
...
(1, 'Micky', '32723732', 'micky@gmail.com', 22, 'Female', ' 1', 'scbbfwb evb'),
(2, 'Lee', '2321324234', 'leebran@gmail.com', 45, 'Male', ' 3', 'schvsjh sdcvsds'),
(3, 'Jim', '2869676273', 'jim@gmail.com', 34, 'Male', ' 5', 'fg fdgdg');
