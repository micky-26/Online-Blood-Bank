...
<div class="row">
    <div class="col-lg-12">
        <h1 class="mt-4 mb-3"><center>Request For Blood </center></h1><br><br>
      </div>
</div>
<form name="donor" action="save.php" method="post">
<div class="row">
...
<div><input type="text" name="bg" style="border: 1px solid black;" class="form-control" required></div>
</div>
<div class="col-lg-4 mb-4">
<div >Address<span style="color:red">*</span></div>
<div><input  type ="text" name="address" style="border: 1px solid black;" class="form-control" required>
