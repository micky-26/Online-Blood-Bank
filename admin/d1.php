    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          ...
          <h1 class="page-title" style="text-align:center;">Donor List</h1>
          <a href="export/index1.php" target="_blank">Export Excel</a> <a href="index2.php"  target="_blank">Export PDF</a>
        </div>
