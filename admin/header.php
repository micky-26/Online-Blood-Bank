...
<nav class="navbar navbar-inverse"  style="background-color:black;">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" id="qq" href="dash1.php" style="color:white;">Admin Panel</a>
    </div>
      ...
      <li class="dropdown"><a class="dropdown-toggle" id="qw" data-toggle="dropdown" href="#" style="font-weight:bold;color:white "> <span class="glyphicon glyphicon-user"></span>&nbsp&nbsp
       ...
       ?><span class="caret"></span></a>
        <ul class="dropdown-menu" style="background-color:black;color: white;">
          <li><a href="change_password.php" style="background-color:black;color: white;">Change Password </a></li>
          <li><a href="logout.php" style="background-color:black;color: white;">Logout</a></li>
        </ul>
    </li>
    </ul>
