    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          ...
          <h1 class="page-title" style="text-align: center;" >Change Password</h1><br><br><br><br>
        </div>
      </div>
          <div class="row">
            <div class="col-md-10" style="padding-left: 200px;">
              <div class="panel panel-default"  style=";border: 1px solid black">
                <div class="panel-heading" style="text-align: center;background-color: black;color: white;" >Password Fields</div>
                <div class="panel-body">
                  <form method="post" name="chngpwd" class="form-horizontal">
                    ...
                    <div class="form-group" method="post">
                      ...
                      <div class="col-sm-8">
                        <input type="password" class="form-control" name="currpassword" style="border: 1px solid black;" id="password" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="password" class="form-control" name="newpassword" style="border: 1px solid black;" id="newpassword" required>
                      </div>
                    </div>
                    <div class="hr-dashed"></div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="password" class="form-control" name="confirmpassword" style="border: 1px solid black;" id="confirmpassword" required>
                      </div>
                    </div>
                    <div class="hr-dashed"></div>
