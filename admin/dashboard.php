    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          <h1 class="page-title" style="text-align: center;">Admin Dashboard</h1>
        </div>
      </div>
      <hr>
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#5cd8ff; border-radius:50px">
              ...
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#5cd8ff;border-radius:50px;">
                  <div class="stat-panel text-center">
                    ...
                    <br>
                    <button class="btn btn-secondary" style="border-radius: 16px;" onclick="window.location.href = 'query.php';">
                      Full Detail <i class="fa fa-arrow-right"></i>
                    </button>
                  </div>
                </div>
              ...
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#5cd8ff ;border-radius:50px; ">
                  <div class="stat-panel text-center">
                    ...
                    <br>
                    <button class="btn btn-secondary" style="border-radius: 16px;" onclick="window.location.href = 'pending_query.php';">
                      Full Detail <i class="fa fa-arrow-right"></i>
                    </button>
                  </div>
                </div>
              ...
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#5cd8ff;border-radius:50px;">
                  <div class="stat-panel text-center">
                    ...
                    <div class="stat-panel-number h1 "><?php echo $row1?></div>
                    <div class="stat-panel-title text-uppercase"> All user feedback </div>
                    <br>
                    <button class="btn btn-secondary" style="border-radius: 16px;" onclick="window.location.href = 'query.php';">
                      Full Detail <i class="fa fa-arrow-right"></i>
                    </button>
