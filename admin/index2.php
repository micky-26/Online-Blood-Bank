 ...
 <html>  
      <head>  
           <title> Export Mysql Data to CSV file in PHP</title>  
      ...
      <body>  
           ...
           <div class="container" style="width:900px;">  
                <h2 align="center">Export Donor Data to PDF file </h2>  
                <h3 align="center">Donor Data</h3>                 
                <br />  
                <form method="post" action="pdf.php" align="center">  
                     <input type="submit" name="pdf" value="PDF Export" class="btn btn-success" />  
                </form>  
                <br />  
                <div class="table-responsive" id="employee_table">  
                     ...
                     ?>  
                          ...
                          <tr>  
                              <td name="donor_id"><?php echo $row["donor_id"]; ?></td>
